package org.agoncal.sample.mcp.migration.azure;
...
public class MigrationAzureMCPServer {

    private static final Logger log = Logger.getLogger(MigrationAzureMCPServer.class);
